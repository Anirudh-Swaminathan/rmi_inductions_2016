    ...
    void dijkstra(int x,int y)
    {
        ...
        while(!q.empty())
        {
            ...
            if(world[cur.first][cur.second] == 'g')
            {
                ...
                end_x = cur.first;
                end_y = cur.second;
                if(dist[xparent[end_x][end_y]][yparent[end_x][end_y]]+1 < dist[end_x][end_y]) dist[end_x][end_y] = dist[xparent[end_x][end_y]][yparent[end_x][end_y]]+1;
                reached = true;
                break;
            }
            //Can I go up
            if(cur.first!=0)
            {
                if(mark[cur.first - 1][cur.second] == 0 && world[cur.first-1][cur.second]!='1')
                {
                    ...
                    if(dist[cur.first-1][cur.second]>dist[cur.first][cur.second]+1) dist[cur.first-1][cur.second] = dist[cur.first][cur.second]+1;
            ...
            if(cur.second!=0)
            {
                if(mark[cur.first][cur.second-1] == 0 && world[cur.first][cur.second-1]!='1')
                {
                    ...
                    if(dist[cur.first][cur.second-1]>dist[cur.first][cur.second]+1) dist[cur.first][cur.second-1] = dist[cur.first][cur.second]+1;
...
public:
    ...
    void print_path()
    {
        if(reached)
        {
            ...
            cout<<"\nThe shortest path using dijkstra is "<<dist[end_x][end_y];
        }
        else
        {
